...
```bash
bunx remotion render --image-format=png --pixel-format=yuva444p10le --codec=prores --prores-profile=4444 MyComp out.mov
```
...
```bash
bunx remotion render --image-format=png --pixel-format=yuva420p --codec=vp9 MyComp out.webm
```
