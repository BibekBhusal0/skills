...
- Import `<Video>` from `@remotion/media`. Import `<TransitionSeries>` from `@remotion/transitions`. If needing to install: `bunx remotion add @remotion/media @remotion/transitions`
