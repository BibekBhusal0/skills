...
This only works from Remotion 4.0.500 and up. Use `bunx remotion versions` to check your Remotion version and `bunx remotion upgrade` to upgrade your Remotion version.
...
```bash
bunx remotion add @remotion/effects
```
