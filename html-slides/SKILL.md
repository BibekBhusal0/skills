...
# Basic Information
name: html-slides
description: Create HTML presentations with reveal.js, slides, themes, transitions, code highlighting, speaker notes. Use when asked to build slides, decks, or presentations.
version: "1.0"
